...
public class ChessBoard {
    ...
    public void initialize(boolean white_pieces_at_bottom) {
        ...
        tileBoard[0][0] = new Rook(color, 0, 0, white_pieces_at_bottom);
        tileBoard[0][1] = new Knight(color, 0, 1,white_pieces_at_bottom);
        tileBoard[0][2] = new Princesse(color, 0, 2,white_pieces_at_bottom);
        tileBoard[0][3] = new Sauterelle(color, 0, 3,white_pieces_at_bottom);
        tileBoard[0][4] = new Bishop(color, 0, 4,white_pieces_at_bottom);
        tileBoard[0][5] = new Queen(color, 0, 5,white_pieces_at_bottom);
        tileBoard[0][6] = new King(color, 0, 6,white_pieces_at_bottom);
        tileBoard[0][7] = new Bishop(color, 0, 7,white_pieces_at_bottom);
        tileBoard[0][8] = new Imperatrice(color,0,8,white_pieces_at_bottom);
        tileBoard[0][9] = new Noctambule(color,0,9,white_pieces_at_bottom);
        tileBoard[0][10] = new Knight(color,0,10,white_pieces_at_bottom);
        tileBoard[0][11] = new Rook(color,0,11,white_pieces_at_bottom);
        for (int j = 0; j < 12; j++) {
            tileBoard[1][j] = new Pawn(color, 1, j,white_pieces_at_bottom);
        }

        // Initialiser les pièces noires
        tileBoard[7][0] = new Rook(oppositeColor, 7, 0,white_pieces_at_bottom);
        tileBoard[7][1] = new Knight(oppositeColor, 7, 1,white_pieces_at_bottom);
        tileBoard[7][2] = new Princesse(oppositeColor, 7, 2,white_pieces_at_bottom);
        tileBoard[7][3] = new Sauterelle(oppositeColor, 7, 3,white_pieces_at_bottom);
        tileBoard[7][4] = new Bishop(oppositeColor, 7, 4,white_pieces_at_bottom);
        tileBoard[7][5] = new Queen(oppositeColor, 7, 5,white_pieces_at_bottom);
        tileBoard[7][6] = new King(oppositeColor, 7, 6,white_pieces_at_bottom);
        tileBoard[7][7] = new Bishop(oppositeColor, 7, 7,white_pieces_at_bottom);
        tileBoard[7][8] = new Imperatrice(oppositeColor, 7, 8,white_pieces_at_bottom);
        tileBoard[7][9] = new Noctambule(oppositeColor, 7, 9,white_pieces_at_bottom);
        tileBoard[7][10] = new Knight(oppositeColor, 7, 10,white_pieces_at_bottom);
        tileBoard[7][11] = new Rook(oppositeColor, 7, 11,white_pieces_at_bottom);
        for (int j = 0; j < 12; j++) {
            tileBoard[6][j] = new Pawn(oppositeColor, 6, j, white_pieces_at_bottom);
        }
